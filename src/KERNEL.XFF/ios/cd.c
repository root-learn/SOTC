...
//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", func_400121D0);
...
//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosIopRead);
...
//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosCdStStart);
...
//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosCdStRead);
...
//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosCdStSkip);
void iosCdStSkip(u32 amount)
{
    D_4007BC10 += amount;
}

//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosCdStSectorAlignSkip);
...
//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosCdSetErrorCallback);
...
//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosCdSetMode);
void iosCdSetMode(s32 mode)
{
    D_40073BD0 = (mode == 1) ? &D_40073BC0 : &D_40073BC8;
}

//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosCdStInit);
...
//INCLUDE_ASM("asm/KERNEL.XFF/nonmatchings/ios/cd", iosCdInit);
void iosCdInit(void)
{
    sceCdInit(0);
    sceCdMmode(2);
