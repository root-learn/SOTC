...
INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", func_400303A8);

INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", iosKeybdInit);
...
//INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", iosKeybdSetCallBackFunc);
...
//INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", func_40030620);
void func_40030620(void) {
    iSignalSema(D_400F6DC0);
}

//INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", iosKeybdGetInfo);
...
INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", func_400306A8);

INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", iosMouseInit);

//INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", iosMouseSetCallBackFunc);
...
//INCLUDE_ASM("asm/kernel/nonmatchings/ios/dev", func_40030970);
